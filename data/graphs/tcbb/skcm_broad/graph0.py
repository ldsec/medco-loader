...
bars.append(ax1.bar(ind + bar_width/2,
...
# Create a bar plot, in position bar_l
bars.append(ax1.bar(ind + bar_width + bar_width/2,
...
# Create a bar plot, in position bar_l
bars.append(ax1.bar(ind + bar_width + bar_width + bar_width/2,
...
ax1.text(ind[0] + bar_width + bar_width + bar_width/2 - 0.10, df['y3_label'][0]+8,
         str(df['y3_label'][0]), color='black', fontweight='bold')
ax1.text(ind[1] + bar_width + bar_width + bar_width/2 - 0.13, df['y3_label'][1]+16,
         str(df['y3_label'][1]), color='black', fontweight='bold')
ax1.text(ind[2] + bar_width + bar_width + bar_width/2 - 0.13, df['y3_label'][2]+32,
